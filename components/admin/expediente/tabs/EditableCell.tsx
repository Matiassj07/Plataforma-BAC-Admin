...
import { BASES_LICITUD } from "./forms/ActividadRatFieldset";
      ...
      <div className="space-y-1">
        ...
        <div className="flex gap-1">
          ...
          <button
            ...
            className="inline-flex items-center gap-0.5 rounded border border-gray-300 px-1.5 py-0.5 text-[10px] font-medium text-gray-600 hover:bg-gray-100"
          >
